...
### hold_location
**Tracking:** Time spent in area

Stay in a specific location for X minutes.
...
```lua copy
{
    ...
    type = 'hold_location',
    name = 'Hangout',
    description = 'Stay at the park for 5 minutes',
    count = 1,
    data = {
        coords = vector3(-250.0, -980.0, 31.0),
        radius = 30.0,
        minutes = 5
    }
}
